...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Add New Destination</h1>
            <p class="mt-1 text-sm text-slate-600">Create a new travel destination for your customers</p>
        </div>
    ...
    <div class="bg-white shadow-sm rounded-lg">
        <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="px-6 py-4 border-b border-slate-200">
                ...
                <p class="mt-1 text-sm text-slate-600">Fill in the details for your new destination</p>
            </div>
            ...
            <div class="px-6 pb-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="@error('description') border-red-300 @enderror">
                        ...
                        <textarea name="description" id="description" required class="hidden">{{ old('description') }}</textarea>
                    </div>
                        ...
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-slate-600">
                                <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                    ...
                                    <input id="image" name="image" type="file" accept="image/jpeg,image/jpg,image/png,image/webp" required class="sr-only">
                                </label>
                                <p class="pl-1">or drag and drop</p>
                            </div>
                            <p class="text-xs text-slate-500">PNG, JPG, WEBP up to 10MB</p>
                            <p class="text-xs text-blue-600 mt-1">💡 Tip: Compress large images to reduce upload time</p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mb-3">Add multiple images to showcase your destination (minimum 3 images required)</p>
                    ...
                    <div id="gallery-container" class="space-y-4">
                        ...
                        <div id="gallery-grid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div id="add-image-btn" class="relative group cursor-pointer">
                                <div class="aspect-square border-2 border-dashed border-slate-300 rounded-lg flex flex-col items-center justify-center hover:border-slate-400 transition-colors bg-slate-50 hover:bg-slate-100">
                                    ...
                                    <span class="text-xs text-slate-400 mt-1">PNG, JPG, WEBP (max 10MB)</span>
                                </div>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-slate-600">
                                Images added: <span id="image-count" class="font-medium text-blue-600">0</span> / 10
                            </span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="price_from" id="price_from" value="{{ old('price_from') }}" step="0.01" min="0" required
                    ...
                    <div>
                        ...
                        <input type="text" name="duration" id="duration" value="{{ old('duration') }}" placeholder="e.g., 7 days" required
...
function updateImageCounter() {
    document.getElementById('image-count').textContent = galleryImages.length;
...
function reindexImages() {
    const imageDivs = document.querySelectorAll('#gallery-grid > div:not(#add-image-btn)');
    imageDivs.forEach((div, newIndex) => {
...
document.querySelector('form').addEventListener('submit', function(e) {
    if (galleryImages.length < 3) {
        e.preventDefault();
        alert('Please add at least 3 gallery images.');
